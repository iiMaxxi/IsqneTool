...
BannerMenu = (f'''
    {Fore.LIGHTBLUE_EX}     ___                         _______             __ 
        ...
        |:  |        |__|             |:  |                 
        |::.|                         |::.|                 
        `---'                         `---'iiMaxxi Tool{Fore.LIGHTWHITE_EX}
    ''')
bannercpf= ('''
...
bannerbin= ('''
    ...
    \___/\___/_//_/___/\_,_/_/\__/\_,_/____/___/_/|_/  
                            By Isqne & iiMaxxi|5512380490xxxxxx 
    ''')
bannerplaca= ('''
      _____                   ____       ___  __             
...
def menu():
    ...
    print(f'''
    {Fore.LIGHTCYAN_EX}╔══════════════════════════════════╗
    ║{Fore.LIGHTWHITE_EX}Ferramenta criada por Isqne & Max{Fore.LIGHTCYAN_EX} ║
    ╚══════════════════════════════════╝ {Fore.LIGHTWHITE_EX}
    ''')
    print(f''' 
    1 - Consulta CEP
...
def consultacpf():
    ...
    'Cookie': "ASPSESSIONIDSCCRRTSA=NGOIJMMDEIMAPDACNIEDFBID;éFGTServer=2A56DE837DA99704910F47A454B42D1A8CCF150E0874FDE491A399A5EF5657BC0CF03A1EEB1C685B4C118A83F971F6198A78",
